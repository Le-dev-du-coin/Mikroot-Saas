      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-2xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white overflow-hidden animate-in zoom-in-95 duration-150">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Instance Mikhmon-Next dédiée & Assistant de connexion
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center px-6 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shrink-0">
          ...
          >
            ...
            <span>Paramètres & Accès Instantané</span>
          </button>
            ...
            <>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-blue-700 dark:text-blue-300">
                      Lien direct vers votre Mikhmon
                    </span>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                    2. Configuration de session pour vos routeurs liés ({routers.length})
                  </h4>
                </div>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs font-mono">
                            <div className="p-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                              <span className="block text-[9px] font-sans text-slate-400 uppercase">
                                Session Name
                              </span>
                            ...
                            <div className="p-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                              ...
                              <span className="font-bold">{vpnServer}</span>
                            </div>
                            ...
                            <div className="p-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                              ...
                              <span className="font-bold text-blue-600 dark:text-blue-400">{apiPort}</span>
                            </div>
                          </div>
                        </div>
                      );
